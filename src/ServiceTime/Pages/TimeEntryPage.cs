...
{
    public class TimeEntryPage : ContentPage
    {


        public static readonly BindableProperty EntryCellHeightProperty =
            BindableProperty.Create<TimeEntryPage, GridLength>(v => v.EntryCellHeight, GridLength.Auto);
        ...
        public static readonly BindableProperty EntryCellWidthProperty =
            BindableProperty.Create<TimeEntryPage, GridLength>(v => v.EntryCellWidth, GridLength.Auto);
        ...
        public static class Styles
        {
            ...
            public static readonly Style TimeEntryPageStyle = EnosixStyles.StyleFor<TimeEntryPage>(style =>
            {
                style.SetValue(ContentPage.TitleProperty, "Time Entry");
                style.SetValue(ContentPage.IconProperty, "tab-icon/timeentry.png");
        ...
        static BindableProperty OperationsProperty = BindableProperty.Create<TimeEntryPage, IEnumerable<ServiceOrderDetailViewModel.ServiceOrderOperationViewModel>>(
        ...
        static BindableProperty DaysProperty = BindableProperty.Create<TimeEntryPage, IEnumerable<ServiceOrderDetailViewModel.DayOfWeekViewModel>>(
